  ...
  head: () => ({
    meta: [
      ...
      { title: "N-DOS — Neuroscience Data Organization System" },
      {
        name: "description",
        content:
          "A browser interface for the N-DOS toolkit: read scan manifests, query sessions, and enter lab metadata.",
      },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "theme-color", content: "#2A2440" },
      { name: "apple-mobile-web-app-capable", content: "yes" },
      { name: "apple-mobile-web-app-title", content: "N-DOS" },
    ],
    links: [
      {
        rel: "stylesheet",
